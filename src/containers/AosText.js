            ...
            <Row style={{marginBottom: 50}} className={'justify-content-center'} >
                ...
                <Col sm={12} md={4} style={{marginBottom: 20}}>
                    <div data-aos="fade-up" className={'h-100'} >
                        <Card style={{backgroundColor: '#f5f5f5', borderRadius: 0, border: "none"}} className={'h-100'}>
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    приумножать и
                                    развивать в дальнейшем. Основное внимание уделяется формированию и развитию у детей
                                    умения
                                    учиться. Научить ребенка учиться, привлечь его внимание к учебе как увлекательной
                                    области
                                    исследований и открытий - именно в этом залог успешного и качественного образования
                                    в более
                                    старшем возрасте.
                                </Card.Text>
                            </Card.Body>
                    ...
                    <div data-aos="fade-up" className={'h-100'}>
                        <Card style={{backgroundColor: '#f5f5f5', borderRadius: 0, border: "none"}} className={'h-100'}>
                            <Card.Body>
                                ...
                                <Card.Text>
                                    Дошкольная подготовка- залог успешной учебы в школе. Для того чтобы успеть за все
                                    более
                                    и более
                        ...
                        <Card style={{backgroundColor: '#f5f5f5', borderRadius: 0, border: "none"}} className={'h-100'}>
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    В этом вам поможет лагерь дневного пребывания на базе начальной школы "Малышок" с
                                    насыщенной спортивной, развлекательной и образовательной программой. Каждый
                                    день в лагере – это веселые занятия робототехникой и английским языком, творчество
                                    Сайт лагеря.
                                </Card.Text>
                            </Card.Body>
                        </Card>
                        ...
                        <Card style={{backgroundColor: '#f5f5f5', borderRadius: 0, border: "none"}} className={'h-100'}>
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    глубоких знаний по различным дисциплинам. Обучение в старшей школе с педагогическим
                                    коллективом и лучшими принципами воспитания дает воспитанникам отличный старт для
