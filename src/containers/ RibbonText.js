        ...
        <div style={{display: "flex", justifyContent: "center", marginTop: 50, marginBottom: 50}} data-aos="zoom-in">
            <div style={{width: 500}}>
                <div style={{textAlign: "center"}}>
                    <h2 className={'\n' +
                    'OurMission'}>НАША МИССИЯ</h2>
                    <div style={{display: "flex", justifyContent: "center"}}>
                        <hr style={{width: 200}}/>
                    </div>
                    <p style={{fontWeight: '400', fontSize: 18}}>Наша школа, действуя в духе лучших педагогических традиций, способствует максимальному развитию
